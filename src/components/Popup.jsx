  ...
  return (
    <div className="noticeWrapper">
      <div className="notice_box">
        <div
          className={`notice_header flex__standart ${
            type === "err" ? "errorWindow" : "infoWindow"
          }`}
        >
          <div className="popup__message flex__standart">
            <span
              className={`flex__center bold ${
                type === "err" ? "icon__error" : "icon__info"
              }`}
            >
              {type === "err" ? "!" : "i"}
            </span>
        ...
        <div className="notice_footer flex__center">
          <button className="button__transp narrow__black" onClick={dismiss}>
            Понятно
          </button>
        </div>
      </div>
