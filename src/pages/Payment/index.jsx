...
export default function Payment() {
  ...
  const checkPhone = (phone) => {
    const result = phone.match(
      /((\+7)|8)-[0-9]{3}-[0-9]{3}-[0-9]{2}-[0-9]{2}/g
    );
    if (result === null)
      throw new Error(
        "Номер телефона введен некорректно. Пример: +7-999-999-99-99",
        { cause: "phone" }
      );
  };
    ...
    <section className="table flex">
      ...
      <div className="column offers">
        ...
        >
          ...
          {errLength > 0 && (
            <div
              className={`form__wrapper__standart flex__standart" ${
